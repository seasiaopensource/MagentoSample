...
use Seasia\Customapi\Api\ColorInterface;
...
class Color implements ColorInterface
{
    ...
    public function getColorObj(){
        ...
        $main['Neon']['name'] = "Neon";
        $main['Neon']['id'] = "663";
        $main['Neon']['colorcode'] = "000000";
        $main['Neon']['imageUrl'] = $mediaUrl."color_obj/neon.png";
        $main['Neon']['children'] = array(
            array(
                'name' => "Neon",
                'id' => "717",
                'colorcode' => "000000",
                'imageUrl' => $mediaUrl."color_obj/neon_r.png"
            )
